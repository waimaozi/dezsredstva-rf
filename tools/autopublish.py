...
def generate_digest(article):
    ...
    prompt = (
        ...
        "На основе абстракта научной статьи напиши качественный дайджест на русском языке.\n\n"
        "Формат ответа — строго JSON:\n"
        '{\n'
        '  "title_ru": "Заголовок на русском (привлекательный, для профессионалов)",\n'
        '  "body_ru": "Текст дайджеста 400-600 слов. Структура: Введение (1 абзац) -> '
        'Что изучали (1 абзац) -> Ключевые результаты (1-2 абзаца) -> Практическое значение (1 абзац). '
        'Пиши просто но профессионально.",\n'
        '  "tags": ["тег1", "тег2", "тег3"]\n'
        '}\n\n'
